    ...
    private class BNLJIterator extends JoinIterator {
        ...
        private void fetchNextLeftBlock() {
            ...
            this.leftRecordIterator =
                    BNLJOperator.this.getBlockIterator(this.getLeftTableName(), leftIterator,
        ...
        private void fetchNextRightPage() {
            ...
            this.rightRecordIterator =
                    BNLJOperator.this.getBlockIterator(this.getRightTableName(), rightIterator, 1);
            this.rightRecordIterator.markNext();
            assert (rightRecordIterator != null);
        }

        // helper
        private void resetAndFetchNextRightPage() {
        ...
        //helper
        private void resetToCurrentRightPageFirstRecord() {
            this.rightRecordIterator.reset();
        }

        //helper
        private void resetToCurrentLeftBlockFirstRecord() {
                    ...
                    if(rightRecordIterator != null) {
                        if(leftRecord != null) {
                            if(rightRecordIterator.hasNext()) {
                                ...
                                this.leftRecord = leftRecordIterator.hasNext() ? leftRecordIterator.next() : null;
                                resetToCurrentRightPageFirstRecord();
                            }
                        }else {
                            fetchNextRightPage();
                            resetToCurrentLeftBlockFirstRecord();
                        }
                    }else {
                        fetchNextLeftBlock();
                        if(leftRecordIterator != null) {
                            resetAndFetchNextRightPage();
                        }
                    }
                }else {
                    throw new NoSuchElementException("No new block to fetch");
                }
            }
        }

...
public class Database implements AutoCloseable {
    ...
    void lockTableMetadata(String tableName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockUtil.ensureSufficientLockHeld(getTableInfoContext(), LockType.IX);
    ...
    void lockIndexMetadata(String indexName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockUtil.ensureSufficientLockHeld(getIndexInfoContext(), LockType.IX);
    ...
    private class TransactionContextImpl extends AbstractTransactionContext {
        ...
        public void close() {
            ...
            List<Lock> locksHeldByTrans = lockman.getLocks(this);
            for(int i=locksHeldByTrans.size()-1; i>=0; i--) {
                LockContext.fromResourceName(lockman, locksHeldByTrans.get(i).name).release(this);
            }
        }
